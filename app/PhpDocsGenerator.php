...
class PhpDocsGenerator implements EventInterface
{
    ...
    private function fileToArray(string $filepath): object
    {
        ...
        $collector = new class {
            ...
            public function addMethod($entityIndex, $name, $visibility, $static, $returnType, $parameters, $description, $lineNumber)
            {
            ...
            public function addProperty($entityIndex, $name, $visibility, $static, $type, $description, $default, $lineNumber)
            {
                if ($visibility === 'private') {
                    return;
                }
        ...
        $traverser->addVisitor(new class($collector) extends NodeVisitorAbstract {
            ...
            public function enterNode(Node $node)
            {
                ...
                if (($node instanceof Node\Stmt\ClassMethod) && $this->currentEntityIndex !== null) {
                    ...
                    $this->collector->addMethod($this->currentEntityIndex, $name, $visibility, $isStatic, $returnType, $parameters, $description, $lineNumber);
                }
                ...
                if (($node instanceof Node\Stmt\Property) && $this->currentEntityIndex !== null) {
                    ...
                    foreach ($node->props as $prop) {
                        ...
                        $this->collector->addProperty($this->currentEntityIndex, $name, $visibility, $isStatic, $type, $description, $default, $lineNumber);
                    }
                }
            }
